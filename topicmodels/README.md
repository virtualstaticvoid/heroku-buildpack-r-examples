...
to demonstrate use of the [topicmodels][package] package.
...
cd heroku-buildpack-r-examples/topicmodels
...
[package]: https://cran.r-project.org/web/packages/topicmodels/index.html
